 ...
 * the output array [2, 6] represents the range {2, 3, 4, 5, 6}, which is a range of length 5. Note that numbers don't need to be
...
public class LargestRange {
    ...
    public static void main(String[] args) {
        ...
        int[] bestRange = largestRange(new int[] {1, 11, 3, 0, 15, 5, 2, 4, 10, 7, 12, 6});
        IntStream.of(bestRange).forEach(System.out::println);
    }
}
